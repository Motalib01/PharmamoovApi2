...
{
    public class PaymentDeliveryBackgroundWorker : IHostedService, IDisposable
    {
        private readonly ILoggerManager logMan;
        private Timer _timer;
        private APIConfigurationManager Config;
        private IPaymentDeliveryBackgroundProcess PaymentProcess { get; }

        public PaymentDeliveryBackgroundWorker(APIConfigurationManager _conf, ILoggerManager _logManager, IPaymentDeliveryBackgroundProcess _iPayProcess)
        {
            logMan = _logManager;
            Config = _conf;
        ...
        private void DoWork(object state)
        {
            ...
            PaymentProcess.TransferFundsFromShopWalletToDeliveryWallet();
        }
